import RubyParseRule from '../rule/RubyParseRule.js';
export default class CommonRubyRuleBuilder { // カクヨム、なろう、エブリスタ、アルファポリス共通 https://kakuyomu.jp/works/1177354054887461010/episodes/1177354054887475663
    #rules = [];
    constructor() {
